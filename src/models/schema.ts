...
export const videos = sqliteTable('videos', {
  ...
  croppedVideoUrl: text('cropped_video_url').notNull(),
  preCaptionVideoUrl: text('pre_caption_video_url').notNull(),
  preCaptionVideoPublicId: text('pre_caption_video_public_id').notNull(),
  captionVideoUrl: text('caption_video_url').notNull(),
  transcript: text('transcript').notNull(),
